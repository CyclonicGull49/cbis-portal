        ...
        <div className="login-left">
          ...
          <div className="login-left-content">
            <div className="brand-mark">
              ...
              <div>
                ...
                <div className="brand-sub">Fe, Cultura, Innovación y Disciplina</div>
              </div>
            </div>

            <div className="left-headline">
              <h1>Gestión académica<br/>hecha <span>simple.</span></h1>
              <p>Consulta tu información académica, realiza tus trámites y mantente al día, todo desde un solo lugar.</p>
          ...
          <div className="left-bottom">
            ...
            <div className="social-row">
              ...
              {/* Facebook */}
              <a href="https://www.facebook.com/share/1GNskn4HmV/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="social-link" title="Facebook">
              ...
              {/* Instagram */}
              <a href="https://www.instagram.com/cbisoficial?fbclid=IwY2xjawQeeeJleHRuA2FlbQIxMABicmlkETF2cWJtaTlUdk81c3c2TTJuc3J0YwZhcHBfaWQQMjIyMDM5MTc4ODIwMDg5MgABHg_rvJYLhyeE54ENfuk7T0GSJqyukzmlG246K78P5q7Y5roAhGQyS2qtXFoY_aem_hVX9vST5I-ty6Ne3iuXbtA" target="_blank" rel="noopener noreferrer" className="social-link" title="Instagram">
              ...
              {/* WhatsApp */}
              <a href="https://wa.me/50369676248" target="_blank" rel="noopener noreferrer" className="social-link" title="WhatsApp">
                <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
