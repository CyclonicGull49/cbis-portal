...
const TIPOS = [
  ...
  { value:'constancia_pago',     label:'Constancia de pago',       desc:'Solicitar constancia que acredite pagos realizados' },
  { value:'constancia_estudio',  label:'Constancia de estudio',    desc:'Solicitar constancia de que su hijo/a es alumno activo' },
]
...
export default function PadreSolicitudes() {
  ...
  async function enviar() {
    ...
    const conFecha   = ['reunion_encargado','reunion_direccion'].includes(form.tipo)
    const payload = {
      tipo:           form.tipo,
  ...
  const conFechaActual = ['reunion_encargado','reunion_direccion'].includes(form.tipo)
          ...
          {conFechaActual && (
            <div style={{ marginBottom:20 }}>
              ...
              <div style={{ display:'flex', alignItems:'center', gap:10, padding:'12px 14px', background:'#f8f7ff', border:'1.5px solid #e9e3ff', borderRadius:11 }}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#c4b5fd" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
